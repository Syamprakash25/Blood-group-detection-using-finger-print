...
def preprocess_image(image):
    ...
    # Convert to array, keep 0–255 range (no division by 255,
    # because training did NOT normalize)
...
def signup():
    if request.method == 'POST':
        ...
        new_user = User(username=username, email=email, password=password)  # No hashing here
